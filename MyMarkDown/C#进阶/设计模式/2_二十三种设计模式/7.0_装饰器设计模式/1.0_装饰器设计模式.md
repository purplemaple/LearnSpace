...
有效地把类的核心功能和装饰功能(放在组件类中实现)分开解耦

![装饰器设计模式的应用场景1](../Assets/装饰器设计模式的应用场景1.png)

![装饰器设计模式的应用场景2](../Assets/装饰器设计模式的应用场景2.png)

![装饰器设计模式UNL图1](../Assets/装饰器设计模式UNL图1.png)

![装饰器设计模式UNL图2](../Assets/装饰器设计模式UNL图2.png)

![装饰器设计模式流程图示](../Assets/装饰器设计模式流程图示.png)
